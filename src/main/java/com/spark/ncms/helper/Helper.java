...
public class Helper {
    ...
    // Auth Queries
    public static final String CHECK_USER = "SELECT * FROM " + TABLE_USERS + " WHERE username=? AND password=?";
    public static final String REGISTER_NEW_USER = "INSERT INTO " + TABLE_USERS + " (username, password, name, role) VALUES (?,?,?,?)";
}
